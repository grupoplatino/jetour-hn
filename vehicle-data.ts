const vehicleData = [
  {
    ...
    cropedWideImages: [
      {
        ...
        images: [
          "/img/DASHING/JETOUR_JX65_cam010 white.jpg",
          "/img/DASHING/Surround Hi-fi 8 speaker.jpg",
        ],
        text: {
    ...
    carGallery: [
      ...
      "/img/DASHING/Foto 02.jpg",
      "/img/DASHING/Foto 03.jpg",
      "/img/DASHING/Foto 04.jpg",
    ],
    carSpecs: {
      "Descripción general": {
        Test: "This is a test",
    ...
    cropedWideImages: [
      {
        ...
        images: [
          "/img/T2/Approach and departure angles.jpg",
          "/img/T2/Magic Electric Door.jpg",
        ],
        text: {
      ...
      },
      {
        ...
        images: [
          "/img/T2/15.6_high-resolution color touchscreen.jpg",
          "/img/T2/Extra Large Storage Space.jpg",
        ],
        text: {
