  ...
  t2: {
    ...
    splitSections: [
      ...
      },
      {
        ...
        text: `La T2 tiene un impresionante tablero, volante multifunción, pantalla touchscreen de 15.6", 12 parlantes SONY, cargador inalámbrico, interior de lujo con asientos ventilados, luces atmosféricas.`,
        brochureUrl:
  ...
  dashing: {
    ...
    specs: {
      ...
      "Confort y comodidad": {
        ...
        Asientos:
          "Asientos tapizados en cuero, Asiento del conductor y pasajero con calefacción y enfriamiento",
      ...
      "Centro de entretenimiento": {
        ...
        Conectividad:
          "Puertos USB delanteros y traseros, Portalentes, Conectividad Mirror Link, Compatible con Apple Carplay y Android Auto inalámbrico",
      },
      "Sistemas avanzados": {
      ...
      "Especificaciones de seguridad": {
        ...
        Control:
          "Control de estabilidad electrónico, Sistema de control de tracción",
        Asistentes:
          "Asistente de ascenso en pendiente, Control de descenso de pendientes",
        Protección: "6 Airbags",
        Monitoreo: "Sistema de monitoreo de presión de llantas",
        Advertencias:
          "Advertencia de colisión frontal y lateral, Advertencia de abandono de carril",
      },
  ...
  x50: {
    ...
    specs: {
      ...
      "Tecnología y conectividad": {
        Pantalla: 'Pantalla dual de 20.5"',
