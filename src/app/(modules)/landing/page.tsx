...
const VideoHeroSection = dynamic(
  () => import("./components/video-hero-section")
);
...
import {
  ...
  LandingSEO,
} from "@/components/seo/landing-seo";
  ...
  return (
    <>
      ...
      <section className="mt-[10px] relative">
        <Image
          className="w-full"
          alt="Logo home jetour"
          height={800}
          width={800}
          unoptimized
          src={"/landing/main_hero_background.webp"}
        />
      ...
      <CarModelsGallery
        models={Object.values(vehiclesData)}
        themeKey="orange"
      />
