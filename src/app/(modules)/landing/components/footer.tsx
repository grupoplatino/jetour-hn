  ...
  return (
    <footer className="relative w-full">
      ...
      <div
        ...
        style={{ backgroundColor: carTheme ? carTheme.primary : primaryColor }}
      ></div>
        ...
        <div className="container mx-auto py-12 px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-4">
                <Image
                  src={"/landing/jetour_logo_black_drive_your_future.webp"}
                  alt="Jetour Logo"
                  width={180}
                  height={60}
              ...
              <p className="text-sm mt-2">
                ...
                diseñados para hacer de tu experiencia de manejo algo
                extraordinario.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-6">
                ...
                <a
                  href="https://www.facebook.com/share/1KuztRECTP/?mibextid=qi2Omg"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full flex items-center justify-center border border-gray-300 hover:bg-gray-200 transition-colors"
                >
                ...
                <a
                  href="https://www.tiktok.com/@jetourhonduras?_t=ZM-8vo0Z7fq90H&_r=1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full flex items-center justify-center border border-gray-300 hover:bg-gray-200 transition-colors"
                >
      ...
      >
        <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm mb-4 md:mb-0">
            © {currentYear} JETOUR Auto. Todos los derechos reservados.
          </div>
