...
export const vehiclesData: Record<string, VehicleData> = {
  t2: {
    ...
    visualizer: {
      ...
      imageCount: 36,
      colors: [
        { name: 'highwayGrey', hex: '#747b89', folderName: 'Highway Grey', class: 'bg-[#747b89]' },
        { name: 'mistyCyan', hex: '#97a8bd', folderName: 'Misty Cyan', class: 'bg-[#97a8bd]' },
        { name: 'white', hex: '#FFFFFF', folderName: 'White', class: 'border border-2' },
        { name: 'nightBlack', hex: '#1d1d1b', folderName: 'Night Black', class: 'bg-[#030304]' },
        { name: 'sand', hex: '#d8cbb1', folderName: 'Sand', class: 'bg-[#d8cbb1]' }
      ],
  ...
  dashing: {
    ...
    colorModels: [
      // Datos para ejemplo - reemplazar con datos reales
      {
        carImage: t2BlackImage, // Reemplazar con la imagen correcta
        color: 'black',
        colorName: 'Negro',
        hexColor: '#000000'
      }
    ...
    features: [
      ...
      { name: 'DISTANCIA ENTRE EJES (MM)', value: 2720, position: 'bottomleft' },
