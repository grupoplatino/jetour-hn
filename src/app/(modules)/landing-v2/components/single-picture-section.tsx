...
const SinglePictureSection: React.FC<SinglePictureSectionProps> = ({ title, image, altText = 'Vehículo Jetour' }) => {
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-start py-28 items-center lg:px-0 px-12">
      <h1 className="font-bold text-5xl uppercase text-center mb-8">{title}</h1>
