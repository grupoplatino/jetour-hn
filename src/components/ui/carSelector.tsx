...
const CarSelector = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center">
      <h1 className="absolute top-24 left-16 font-bold text-3xl">
        Nuestros Modelos
      </h1>
      ...
      <div className="flex flex-row gap-2 absolute right-0">
        <div className="bg-[#f28b2d] w-2 h-12 -skew-x-12"></div>
        <div className="bg-[#f28b2d] w-2 h-12 -skew-x-12"></div>
        <div
          className="ml-[-3px] bg-[#f28b2d] flex flex-row justify-center items-center px-8"
